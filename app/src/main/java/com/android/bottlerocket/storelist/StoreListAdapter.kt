...
class StoreListAdapter : ListAdapter<Store, StoreListAdapter.StoreViewHolder>(DiffCallback()) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =
        StoreViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_store, parent, false))
    ...
    inner class StoreViewHolder(private val view: View) : RecyclerView.ViewHolder(view) {
        fun bind(store: Store) = with(view) {
